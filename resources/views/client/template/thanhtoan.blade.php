    ...
    <div class="col-md-12">
        ...
        <form method="POST" action="{{ route('dat-hang') }}">
            ...
            <div class="form-group">
                <label>Họ tên: </label>
                <input type="text" class="form-control" name="nguoiNhan" value="{{ Session::get('ht')}}">
            </div>
            <div class="form-group">
                <label>Số điện thoại: </label>
                <input type="text" class="form-control" name="sdt" value="{{ Session::get('sdt') }}">
            </div>
            <div class="form-group">
                <label>Địa chỉ: </label>
                <input type="text" class="form-control" name="diaChi" value="{{ Session::get('dc') }}">
            </div>
            <div class="form-group">
